...
function Home () {
    return (
        <Layout>
            ...
            header="My bank"
            description="[Temporaly being slow. Please be patient]This app uses React, Node.js(Express), MongoDB, Firebase Authentication. It demonstrate my skill of creatig a secure app with RESTful API with MERN stack."
            />
            <Card
            link="#"
